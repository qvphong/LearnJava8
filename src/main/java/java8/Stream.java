...
public class Stream {
    public static void main1(String[] args) {
        ...
        List<Integer> sortInt = Arrays.asList(1, 4, 8, 4, 2, 9);
        System.out.println("Sorted list: ");
        sortInt.stream().distinct().sorted().forEach(System.out::print);

        //Parallel Processing
        List<String> str = Arrays.asList("abc", "", "bc", "efg", "abcd", "", "jkl");
        //get count of empty string
        Long c = str.parallelStream().filter(st -> st.isEmpty()).count();
        System.out.println("Parallel Processing: " + c);

        //Collectors
        List<String> strings1 = Arrays.asList("abc", "", "bc", "efg", "abcd", "", "jkl");
        List<String> filtered1 = strings1.stream().filter(string1 -> !string1.isEmpty()).collect(Collectors.toList());

        System.out.println("Filtered List: " + filtered);
        String mergedString = strings1.stream().filter(string1 -> !string1.isEmpty()).collect(Collectors.joining(", "));
