 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://SoapService.java8/", wsdlLocation = "http://localhost:1212/say?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://SoapService.java8/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1212/say?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://SoapService.java8/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://SoapService.java8/", "SoapServicePort"), SoapService.class, features);
    }
